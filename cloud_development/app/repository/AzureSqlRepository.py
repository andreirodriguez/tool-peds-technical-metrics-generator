...
class AzureSqlRepository():
    ...
    def getSummarySqlDatabases(self)->pd.DataFrame:
        data = Utils.getAllResourcesAzureType(Constants.PATH_INPUT_AZURE_MONITOR,Constants.AZURE_MONITOR_FILE_SUMMARY_AZURE_SQL,Constants.AZURE_MONITOR_AZURE_SQL_COLUMNS)
