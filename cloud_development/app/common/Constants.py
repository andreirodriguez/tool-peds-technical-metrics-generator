...
AZURE_MONITOR_AZURE_COSMOS_QUANTITY_RUNNING:float = 400
AZURE_MONITOR_AZURE_COSMOS_PERCENTAGE_PROVISIONEDTHROUGHPUT :float = 10
...
AZURE_MONITOR_AZURE_COSMOS_PROVISIONEDTHROUGHPUT_PROPOSED :float = 6000

HOURS_FOR_DAYS :int = 24
DAYS_FOR_MONTH_AZURE :float = 30.416


METRIC_MODEL_VARIABLE_TYPE_ASSESMENT:str = "assesment"
METRIC_MODEL_VARIABLE_TYPE_SONAR:str = "sonar"
METRIC_MODEL_VARIABLE_TYPE_AZURE:str = "azure"


METRIC_MODEL_VARIABLE:str = "variable"
METRIC_MODEL_METRIC:str = "metric"
METRIC_MODEL_CATEGORY:str = "category"