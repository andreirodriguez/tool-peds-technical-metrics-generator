...
class MaturityLevelService():
    ...
    def __getColumnsMetricsAzureByServiceCloud(self,serviceCloud:str)->list[str]:
        ...
        if(serviceCloud==Constants.SERVICE_CLOUD_AZURE_SQL):
            ...
            columns += ["provisionedMinThroughput","autoscaleMaxThroughput","provisionedMaxThroughput","azureCosts","averageHalfRequestUnits","maximumRequestUnits","averageSpikesRequestUnits","provisionedMinThroughputProposed","spikesThroughputProposed","autoscaleMaxThroughputProposed"]
